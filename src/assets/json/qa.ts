const qacontent: IQAContent[] = [
  ...
  <div class="qa-content-container">
      ...
      <ul>
          <li>
              การเติมเครดิตขั้นต่ำ เริ่มต้นที่ 100 บาท การแจ้งฝากทุกธนาคารห้ามแจ้งฝากข้ามวันหลังจากโอนเงินเข้ามาแล้วให้สมาชิกแจ้งฝากเลยทุกครั้ง หากเกินจะถือเป็นโมฆะเพราะจะไม่สามารถตรวจสอบยอดเงินได้ และทางเราจะไม่รับผิดชอบหากเกิดปัญหา
          </li>
      </ul>
  </div>`,
    },
